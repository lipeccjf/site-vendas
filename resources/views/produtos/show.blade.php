...
<body data-is-admin="{{ $isAdmin ? 'true' : 'false' }}">
    <div class="pagina-produto">
        ...
        <section class="conteiner-dir">
            <header class="topo-pagina">
                ...
                <div class="usuario-topo">{{ Auth::user()->nome ?? 'Usuário logado' }}</div>
            </header>
    ...
    @vite(['resources/js/paginaproduto.js'])
</body>
</html>